...
<p><FONT COLOR="cc0000">По результатам регрессионного тестирования выявлена поломка в системе. Теперь учителю невозможно отменить урок. До починки этого бага новый функционал выпускать не рекомендуется!</font></p>
