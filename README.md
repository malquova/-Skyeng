# Личные события в личном кабинете преподавателя SkyEng
...
<h2>Отчет о тестировании итогового проекта</h2>
...
<b>! По результатам регрессионного тестирования выявлена поломка в системе. Теперь учителю невозможно отменить урок. До починки этого бага новый функционал выпускать не рекомендуется !</b>

В остальном, продукт справляется со своим функционалом, однако стоит обратить внимание на дизайн интерфейса, который делает два и более событий в одно время нечитабельными: чтобы узнать, что там за событие, нужно по нему кликнуть. Прилагаю скриншот:

![9d26d3d6-9fae-4bc4-a1d5-3a1d1523e999](https://user-images.githubusercontent.com/106274596/202248327-ab12791d-6deb-4ad6-b4f4-ceafb69b796f.png)
